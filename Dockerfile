...
RUN apt update
RUN apt -y upgrade
RUN apt -y install php8.0-fpm php8.0-common php8.0-gmp php8.0-curl php8.0-intl php8.0-mbstring php8.0-xmlrpc php8.0-gd php8.0-xml php8.0-cli php8.0-zip php8.0-soap php8.0-imap --fix-missing
# RUN apt -y php8.0-mysql ## removed because cirtical vulnerabilities. If you need this, rebuild your image by yourself.
